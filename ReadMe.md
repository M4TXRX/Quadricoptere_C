...
_Ce projet ayant été réalisé il y a déjà un moment dans mes études, il manque malheureusement certaines informations. Je n'ai plus le schéma électronique de la carte du microcontroleur ATMEGA 1280 avec tous les éléments qui y sont placés, il est donc à refaire. Il manque également les spécifications des moteurs, des hélices, de la batterie et du récepteur radio utilisés. Ces points sont donc à redéfinir._
